...
public class AppConstants {
    public static class NetworkTaskCodes {
        ...
        public static final int GET_CITY_INSIGHTS = 4;
    }

    public static class ApiEndpoints {
        public static final String GO_IBIBO_HOTEL = "http://www.goibibo.com/hotels/hotels-in-";
        public static final String ZOOMCAR_CAR_RENTAILS = "https://www.zoomcar.com/";
